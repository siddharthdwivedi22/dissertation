...
<?php $res = mysqli_query($conn,"SELECT * FROM `events` WHERE userID='$userId' AND saved='1' ORDER BY startDate ASC"); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-8">
                ...
                <div class="row">
                    ...
                    $query = "SELECT * FROM events WHERE userID='$userId' AND saved='1' ORDER BY startDate LIMIT $start_from, $per_page";
                    ...
                    <div class="center">
                        <ul class="pagination">
                            ...
                            //Going to first page
                            if($_GET['page'] != 1) {
                                echo '<li><a href="buysalerent.php?page=1">First Page</a></li> ';
                            }
                            for ($i=1; $i<=$total_pages; $i++) {

                                echo '<li><a href="buysalerent.php?page='.$i.'">'.$i.'</a></li>';
                            }
                            // Going to last page
                            echo '<li><a href="buysalerent.php?page='.$total_pages.'">Last Page</a></li> ';
                            ?>
